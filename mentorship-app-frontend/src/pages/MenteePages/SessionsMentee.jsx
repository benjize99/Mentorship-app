...
const SessionsMentee = () => {
  ...
  // Sample session data (replace with real data or fetch from API)
  const sessions = [
    { id: 1, mentor: "Alex Smith", date: "2025-07-10", status: "Upcoming" },
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto py-8">
        <h1 className="text-2xl font-bold mb-6 m-3">My Sessions</h1>
        <table className="min-w-full bg-white rounded shadow">
          ...
          <tbody>
            {sessions.map(({ id, mentor, date, status }) => (
              <tr key={id}>
