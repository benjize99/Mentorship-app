...
const SessionsMentor = () => {
  ...
  const sessions = [
    { id: 1, mentee: "Emily Johnson", date: "2025-07-10", status: "Upcoming" },
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="flex flex-grow">
        ...
        <table className="min-w-full bg-white rounded shadow">
          <thead>
            <tr>
              <th className="py-2 px-4 border-b text-left">Mentee</th>
              <th className="py-2 px-4 border-b text-left">Date</th>
              <th className="py-2 px-4 border-b text-left">Status</th>
            </tr>
          </thead>
          <tbody>
            {sessions.map(({ id, mentee, date, status }) => (
              <tr key={id}>
                <td className="py-2 px-4 border-b">{mentee}</td>
