  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="flex flex-grow">
        ...
        {/* Main Content */}
        <main className="bg-white p-8 rounded shadow-md w-full max-w-md mx-auto mt-10 h-full">
          <h1 className="text-2xl font-bold mb-6 text-center">Set Availability</h1>
          <form>
            <div className="mb-4">
              <label className="block mb-2 text-sm font-medium">Available Days</label>
...
export default AvailabilityMentor;
